...
const (
	...
	WorkmachineSpecAwsAvailabilityZone       = "spec.aws.availabilityZone"
	...
	WorkmachineSpecAwsPublicSubnetId         = "spec.aws.publicSubnetId"
	WorkmachineSpecAwsRegion                 = "spec.aws.region"
...
const (
	...
	WorkspaceSpecNodeName                   = "spec.nodeName"
	WorkspaceSpecRouter                     = "spec.router"
	WorkspaceSpecRouterBackendProtocol      = "spec.router.backendProtocol"
	WorkspaceSpecRouterBasicAuth            = "spec.router.basicAuth"
	WorkspaceSpecRouterBasicAuthEnabled     = "spec.router.basicAuth.enabled"
	WorkspaceSpecRouterBasicAuthSecretName  = "spec.router.basicAuth.secretName"
	WorkspaceSpecRouterBasicAuthUsername    = "spec.router.basicAuth.username"
	WorkspaceSpecRouterCors                 = "spec.router.cors"
	WorkspaceSpecRouterCorsAllowCredentials = "spec.router.cors.allowCredentials"
	WorkspaceSpecRouterCorsEnabled          = "spec.router.cors.enabled"
	WorkspaceSpecRouterCorsOrigins          = "spec.router.cors.origins"
	WorkspaceSpecRouterDomains              = "spec.router.domains"
	WorkspaceSpecRouterHttps                = "spec.router.https"
	WorkspaceSpecRouterHttpsClusterIssuer   = "spec.router.https.clusterIssuer"
	WorkspaceSpecRouterHttpsEnabled         = "spec.router.https.enabled"
	WorkspaceSpecRouterHttpsForceRedirect   = "spec.router.https.forceRedirect"
	WorkspaceSpecRouterIngressClass         = "spec.router.ingressClass"
	WorkspaceSpecRouterMaxBodySizeInMB      = "spec.router.maxBodySizeInMB"
	WorkspaceSpecRouterRateLimit            = "spec.router.rateLimit"
	WorkspaceSpecRouterRateLimitConnections = "spec.router.rateLimit.connections"
	WorkspaceSpecRouterRateLimitEnabled     = "spec.router.rateLimit.enabled"
	WorkspaceSpecRouterRateLimitRpm         = "spec.router.rateLimit.rpm"
	WorkspaceSpecRouterRateLimitRps         = "spec.router.rateLimit.rps"
