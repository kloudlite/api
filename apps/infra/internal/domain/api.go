...
type Domain interface {
	...
	ListClusters(ctx InfraContext, search *string, pagination t.CursorPagination) (*repos.PaginatedRecord[*entities.Cluster], error)
	...
	ListBYOCClusters(ctx InfraContext, search *string, pagination t.CursorPagination) (*repos.PaginatedRecord[*entities.BYOCCluster], error)
	...
	ListProviderSecrets(ctx InfraContext, search *string, pagination t.CursorPagination) (*repos.PaginatedRecord[*entities.CloudProviderSecret], error)
	...
	ListNodePools(ctx InfraContext, clusterName string, search *string, pagination t.CursorPagination) (*repos.PaginatedRecord[*entities.NodePool], error)
