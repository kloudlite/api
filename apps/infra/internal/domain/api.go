...
type Domain interface {
	...
	ListBYOCClusters(ctx InfraContext) (*repos.PaginatedRecord[*entities.BYOCCluster], error)
	...
	ListClusters(ctx InfraContext) (*repos.PaginatedRecord[*entities.Cluster], error)
	...
	ListCloudProviders(ctx InfraContext) (*repos.PaginatedRecord[*entities.CloudProvider], error)
	...
	ListEdges(ctx InfraContext, clusterName string, providerName *string) (*repos.PaginatedRecord[*entities.Edge], error)
	...
	ListNodePools(ctx InfraContext, clusterName string, edgeName string) (*repos.PaginatedRecord[*entities.NodePool], error)
	GetNodePool(ctx InfraContext, clusterName string, edgeName string, poolName string) (*entities.NodePool, error)

	ListMasterNodes(ctx InfraContext, clusterName string) (*repos.PaginatedRecord[*entities.MasterNode], error)

	ListWorkerNodes(ctx InfraContext, clusterName string, edgeName string) (*repos.PaginatedRecord[*entities.WorkerNode], error)
